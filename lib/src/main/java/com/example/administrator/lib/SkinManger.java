...
public class SkinManger extends Observable {

    private volatile static SkinManger instance;
    /**
     * Activity生命周期回调
     */
    ...
    public static void init(Application application) {
        if (instance == null) {
            synchronized (SkinManger.class) {
                if (instance == null) {
                    instance = new SkinManger(application);
                }
            }
        }
    }
    ...
    private SkinManger(Application application) {
...
//
                ...
                SkinResourcesUtils.getInstance().applySkin(skinResource, packageName);
    ...
    private static final String TAG = "SkinManger";
